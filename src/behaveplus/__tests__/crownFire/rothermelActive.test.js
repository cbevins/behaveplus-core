...
test('3: Rothermel active crown fire - linked to surfaceFire', () => {
  ...
  expect(requiredInputs).toContain(
    dag.get('surface.primary.fuel.model.catalogKey')
  )
  expect(requiredInputs).toContain(
    dag.get('surface.primary.fuel.model.behave.parms.cured.herb.fraction')
  )
