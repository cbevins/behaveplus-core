...
test('1: wind.direction - fire.vector combination tests', () => {
  ...
  expect(nodeHeadScorch.value.current).toEqual(headScorch)
  expect(nodeBackScorch.value.current).toEqual(backScorch)
  expect(nodeFlankScorch.value.current).toEqual(flankScorch)
  expect(nodeBetaRos.value.current).toEqual(betaRos)
  expect(nodeBetaScorch.value.current).toEqual(betaScorch)
  expect(nodeBeta5Scorch.value.current).toEqual(beta5Scorch)
  expect(nodePsiScorch.value.current).toEqual(psiScorch)
