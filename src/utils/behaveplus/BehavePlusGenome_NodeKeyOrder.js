// BehavePlus Genome in Node key order (1208 nodes)
export const GenomeArray = [
  ...
  ['crown.fire.surface.firelineIntensity', [['Variant.FireFirelineIntensity'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.firelineIntensity'],
    ['finally', 'Dag.bind', 'site.fire.observed.firelineIntensity']]]],
  ['crown.fire.surface.flameLength', [['Variant.FireFlameLength'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.flameLength'],
    ['finally', 'Dag.bind', 'site.fire.observed.flameLength']]]],
  ['crown.fire.surface.heatPerUnitArea', [['Variant.FireHeatPerUnitArea'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.heatPerUnitArea'],
  ...
  ['spotting.crownFire.firelineIntensity', [['Variant.FireFirelineIntensity'], [
    ['when', 'configure.module', 'includes', ['crownFire', 'surfaceFire'], 'Dag.bind', 'crown.fire.active.firelineIntensity'],
  ...
  ['surface.fire.ellipse.axis.effectiveWindSpeed', [['Variant.WindSpeed'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.effectiveWindSpeed'],
  ...
  ['surface.fire.ellipse.axis.lengthToWidthRatio', [['Variant.FireLengthToWidthRatio'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.lengthToWidthRatio'],
  ...
  ['surface.fire.ellipse.head.spreadRate', [['Variant.FireSpreadRate'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.spreadRate'],
  ...
  ['surface.fire.ellipse.heading.fromUpslope', [['Variant.CompassAzimuth'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.heading.fromUpslope'],
  ...
  ['surface.fire.ellipse.wind.speed.atMidflame', [['Variant.WindSpeed'], [
    ['when', 'configure.module', 'equals', 'surfaceFire', 'Dag.bind', 'surface.weighted.fire.wind.speed.atMidflame'],
  ...
  ['surface.primary.fuel.model.behave.parms.cured.herb.fraction', [['Variant.FuelDeadFraction'], [
    ['when', 'configure.fuel.curedHerbFraction', 'equals', 'estimated', 'Behave.curedHerbFraction', 'site.moisture.live.herb'],
    ['finally', 'Dag.input']]]],
  ...
  ['surface.primary.fuel.model.palmettoGallberry.parms.age', [['Variant.FuelAge'], [
    ['when', 'configure.fuel.primary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylAge', 'surface.primary.fuel.model.catalogKey'],
  ...
  ['surface.primary.fuel.model.palmettoGallberry.parms.basalArea', [['Variant.FuelBasalArea'], [
    ['when', 'configure.fuel.primary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylBasalArea', 'surface.primary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.primary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0]]]],
  ['surface.primary.fuel.model.palmettoGallberry.parms.cover', [['Variant.FuelCoverFraction'], [
    ['when', 'configure.fuel.primary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylCover', 'surface.primary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.primary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0]]]],
  ['surface.primary.fuel.model.palmettoGallberry.parms.height', [['Variant.FuelBedDepth'], [
    ['when', 'configure.fuel.primary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylHeight', 'surface.primary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.primary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0.01]]]],
  ...
  ['surface.secondary.fuel.model.palmettoGallberry.parms.age', [['Variant.FuelAge'], [
    ['when', 'configure.fuel.secondary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylAge', 'surface.secondary.fuel.model.catalogKey'],
  ...
  ['surface.secondary.fuel.model.palmettoGallberry.parms.basalArea', [['Variant.FuelBasalArea'], [
    ['when', 'configure.fuel.secondary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylBasalArea', 'surface.secondary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.secondary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0]]]],
  ['surface.secondary.fuel.model.palmettoGallberry.parms.cover', [['Variant.FuelCoverFraction'], [
    ['when', 'configure.fuel.secondary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylCover', 'surface.secondary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.secondary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0]]]],
  ['surface.secondary.fuel.model.palmettoGallberry.parms.height', [['Variant.FuelBedDepth'], [
    ['when', 'configure.fuel.secondary', 'equals', 'catalog', 'FuelCatalog.palmettoGallberrylHeight', 'surface.secondary.fuel.model.catalogKey'],
    ['when', 'configure.fuel.secondary', 'equals', 'palmettoGallberry', 'Dag.input'],
    ['finally', 'Dag.fixed', 0.01]]]],
