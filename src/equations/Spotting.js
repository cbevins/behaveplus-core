 ...
 */
export function appliedDownWindCoverHt (downWindCoverHt, downWindCanopyIsOpen) {
 ...
 */
export function burningPileFirebrandHt (flameHt) {
 ...
 */
export function criticalCoverHt (firebrandHt, appliedDownWindCoverHt) {
  const criticalHt =
 ...
 */
export function distanceFlatTerrain (firebrandHt, criticalCoverHt, u20) {
  // Wind speed must be converted to mi/h
  return criticalCoverHt <= 0
    ? 0
    : 5280 *
        0.000718 *
        (u20 / 88) *
        Math.sqrt(criticalCoverHt) *
        (0.362 +
          (Math.sqrt(firebrandHt / criticalCoverHt) / 2) *
            Math.log(firebrandHt / criticalCoverHt))
}
 ...
 */
export function surfaceFireCriticalCoverHt (
  firebrandHt,
  appliedDownWindCoverHt
) {
 ...
 */
export function surfaceFireFirebrandHt (firelineIntensity, u20) {
  if (u20 > 0 && firelineIntensity > 0) {
    ...
    const product = f * firelineIntensity
 ...
 * \return Maximum firebrand height (ft+1)
 */
export function torchingTreesFirebrandHt (treeHt, flameHt, flameDur) {
  const parms = [
    { a: 4.24, b: 0.332 },
    { a: 3.64, b: 0.391 },
    { a: 2.78, b: 0.418 },
 ...
 */
export function torchingTreesSteadyFlameHt (species, dbh, trees) {
  return (
